  ...
  return (
    ...
    >
      <div className="container max-w-7xl px-6 relative z-10 flex flex-col items-center">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 lg:gap-10 w-full mb-12 md:mb-16">
          ...
          {/* אילוסטרציה ענקית - צד שמאל, גדולה מאוד */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 w-full max-w-5xl mx-auto">
            {stats.map((stat, index) => (
              <div key={index} className="flex flex-col items-center text-center">
                ...
                <span className="text-7xl md:text-8xl font-extrabold text-[#C9A0A8] mb-2 leading-none tracking-tighter">
                  {stat.value}
                </span>
