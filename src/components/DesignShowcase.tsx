...
const DesignShowcase = () => {
  ...
  return (
    <>
      <section id="showcase" ref={sectionRef} className="showcase-section relative py-12 md:py-24" style={{ background: "linear-gradient(to bottom, #FFFFFF 0%, #F8F6F3 25%, #F5F2EE 50%, #F8F6F3 75%, #FFFFFF 100%)" }}>
