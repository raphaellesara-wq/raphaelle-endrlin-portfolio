...
const DesignShowcase = () => {
  ...
  return (
    <>
      <section id="showcase" ref={sectionRef} className="showcase-section relative py-12 md:py-24" style={{ background: "linear-gradient(to bottom, #F8F6F3 0%, #F5F2EE 50%, #F2EFE9 100%)" }}>
