...
const DesignShowcase = () => {
  ...
  return (
    <>
      <section id="showcase" ref={sectionRef} className="showcase-section relative py-12 md:py-24" style={{ background: "linear-gradient(to bottom, #FFFFFF 0%, #FAFAF8 15%, #FAFAF8 85%, #FFFFFF 100%)" }}>
