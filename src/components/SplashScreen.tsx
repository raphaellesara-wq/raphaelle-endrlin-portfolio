  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center gap-6 md:gap-8">
        ...
        <svg viewBox="0 0 200 260" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-48 md:w-64 h-auto">
          {/* Level 1 */}
          <rect
          ...
          {/* Lines L1 -> L2 */}
          <line
            x1="100" y1="46" x2="45" y2="75"
            stroke="hsl(348,30%,70%)" strokeWidth="1.5" strokeLinecap="round" strokeDasharray="4 4"
            className="transition-all duration-400"
            style={{ opacity: showLine1 ? 0.5 : 0 }}
          />
          <line
            x1="100" y1="46" x2="155" y2="75"
            stroke="hsl(155,30%,65%)" strokeWidth="1.5" strokeLinecap="round" strokeDasharray="4 4"
            className="transition-all duration-400"
            style={{ opacity: showLine1 ? 0.5 : 0 }}
          />
          ...
          {/* Level 2 */}
          <rect
            x="15" y="75" width="60" height="36" rx="10"
          ...
          />
          <rect
            x="125" y="75" width="60" height="36" rx="10"
          ...
          {/* Lines L2 -> L3 */}
          <line
            x1="45" y1="111" x2="45" y2="140"
            stroke="hsl(27,35%,60%)" strokeWidth="1.5" strokeLinecap="round" strokeDasharray="4 4"
            className="transition-all duration-400"
            style={{ opacity: showLine2 ? 0.5 : 0 }}
          />
          <line
            x1="155" y1="111" x2="155" y2="140"
            stroke="hsl(258,18%,60%)" strokeWidth="1.5" strokeLinecap="round" strokeDasharray="4 4"
            className="transition-all duration-400"
            style={{ opacity: showLine2 ? 0.5 : 0 }}
          />
          ...
          {/* Level 3 */}
          <rect
            x="15" y="140" width="60" height="36" rx="10"
            stroke="hsl(27,35%,60%)" strokeWidth="2" fill="hsl(27,40%,96%)"
            className="transition-all duration-500"
            style={{
              opacity: showRect3 ? 1 : 0,
              transform: showRect3 ? "translateY(0)" : "translateY(-10px)",
              transitionDelay: "0ms"
            }}
          />
          <rect
            x="125" y="140" width="60" height="36" rx="10"
            stroke="hsl(258,18%,60%)" strokeWidth="2" fill="hsl(258,20%,97%)"
            className="transition-all duration-500"
            style={{
              opacity: showRect3 ? 1 : 0,
          ...
          {/* Lines L3 -> L4 */}
          <line
            x1="45" y1="176" x2="100" y2="205"
            stroke="hsl(348,30%,70%)" strokeWidth="1.5" strokeLinecap="round" strokeDasharray="4 4"
            className="transition-all duration-400"
            style={{ opacity: showLine3 ? 0.5 : 0 }}
          />
          <line
            x1="155" y1="176" x2="100" y2="205"
            stroke="hsl(155,30%,65%)" strokeWidth="1.5" strokeLinecap="round" strokeDasharray="4 4"
            className="transition-all duration-400"
            style={{ opacity: showLine3 ? 0.5 : 0 }}
          />
          ...
          {/* Level 4 */}
          <rect
            x="70" y="205" width="60" height="36" rx="10"
            stroke="hsl(348,30%,70%)" strokeWidth="2" fill="hsl(348,30%,97%)"
            className="transition-all duration-500"
            style={{
              opacity: showRect4 ? 1 : 0,
              transform: showRect4 ? "translateY(0)" : "translateY(-10px)",
